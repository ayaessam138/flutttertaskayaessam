...
class BuildingCaseFilter extends StatelessWidget {
  const BuildingCaseFilter({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              FilterWidget(title: "أى "),
              FilterWidget(title: " جاهز"),
              FilterWidget(title: " قيد الأنشاء"),
            ],
          ),
        ],
      ),
