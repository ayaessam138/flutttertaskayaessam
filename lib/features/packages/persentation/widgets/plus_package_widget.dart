...
class PlusPackageWidget extends StatefulWidget {
  const PlusPackageWidget({super.key, required this.packageModel});
  final PackageModel packageModel;
  @override
  State<PlusPackageWidget> createState() => _PlusPackageWidgetState();
}

class _PlusPackageWidgetState extends State<PlusPackageWidget> {
    ...
    return Stack(
      ...
      children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        flex: 2,
                        child: PackagesViewsWidget(
                          viewsimage: AppImages.views18,
                        ),
                      ),
                    ],
                  ),
        ...
        Padding(
          ...
          child: SvgPicture.asset(AppImages.plusPackageBadge),
        ),
      ],
    );
  }
